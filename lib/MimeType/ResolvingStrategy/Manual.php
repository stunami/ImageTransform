...
/**
 *
 * MimeType_ResolvingStrategy_Manual
 *
 * ...
 *
 ...
 * @version    SVN: $Id$
 */
class MimeType_ResolvingStrategy_Manual implements MimeType_ResolvingStrategy_Interface
{
  /**
  ...
  {
    return $mimetype; // Accept the passed choice. If false return false.
  }
}
